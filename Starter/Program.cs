    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\r\nEnter dog characteristic to search for separated commas");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                    dogCharacteristic = readResult.ToLower().Trim();

                    searches = dogCharacteristic.Split(",");
                    Array.Sort(searches);
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    for (int j = 2; j > -1; j--)
                    {
                        ...
                        foreach (string icon in searchingIcons)
                        {
                            ...
                            Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {searches} {icon} {j.ToString()}");
                            Thread.Sleep(100);
                        }
                    ...
                    if (searches != null)
                    {
                        foreach (var item in searches)
                        {
                            if (dogDescription.Contains(item))
                            {
                                ...
                                //Console.WriteLine($"{ourAnimals[i, 3]} :" + dogCharacteristic);
